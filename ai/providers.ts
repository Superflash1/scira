...
// 自定义第三方OpenAI兼容API
const customAPI = createOpenAICompatible({
  name: 'custom-api',
  baseURL: 'http://43.173.125.108:3002/v1',
...
export const scira = customProvider({
  languageModels: {
    // 自定义第三方API模型
    'scira-gemini-3-flash': customAPI.chatModel('gemini-3-flash-preview'),
    'scira-gemini-3-pro': customAPI.chatModel('gemini-3-pro-preview'),
    'scira-anthropic-thinking': customAPI.chatModel('claude-sonnet-4.5-thinking'),
    'scira-kimi-k2.5': customAPI.chatModel('moonshotai/Kimi-K2.5'),
    'scira-qwen-397b': customAPI.chatModel('Qwen/Qwen3.5-397B-A17B'),
    'scira-glm-5': customAPI.chatModel('ZhipuAI/GLM-5'),
...
export const models: Model[] = [
  // 自定义第三方API模型
  {
    ...
    label: 'Gemini 3 Flash (Custom)',
    description: "Google's latest small SOTA LLM via custom API",
    vision: true,
    reasoning: false,
    experimental: false,
    category: 'Custom',
  ...
  },
  {
    ...
    label: 'Gemini 3 Pro (Custom)',
    description: "Google's latest SOTA LLM via custom API",
    vision: true,
    reasoning: false,
    experimental: false,
    category: 'Custom',
  ...
  },
  {
    ...
    label: 'Claude Sonnet 4.5 Thinking (Custom)',
    description: "Anthropic's latest and greatest LLM with thinking via custom API",
    vision: true,
    reasoning: true,
    experimental: false,
    category: 'Custom',
  ...
  },
  {
    ...
    label: 'Kimi K2.5 (Custom)',
    description: "MoonShot AI's advanced LLM via custom API",
    vision: true,
    reasoning: false,
    experimental: false,
    category: 'Custom',
  ...
  {
    value: 'scira-qwen-397b',
    label: 'Qwen 3.5 397B (Custom)',
    description: "Alibaba's advanced large LLM via custom API",
    vision: false,
    reasoning: false,
    experimental: false,
    category: 'Custom',
  ...
  },
  {
    value: 'scira-glm-5',
    label: 'GLM-5 (Custom)',
    description: "Zhipu AI's advanced LLM via custom API",
    vision: false,
    reasoning: false,
    experimental: false,
    category: 'Custom',
